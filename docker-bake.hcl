...
target "image" {
  ...
  cache-from = variant == "default" ? ["type=gha"] : [
    "type=s3,endpoint_url=https://b172f19b7e057975835d8d311a7b0dbd.r2.cloudflarestorage.com,bucket=github,region=auto",
  ]
  cache-to   = variant == "default" ? ["type=gha,mode=max"] : [
    "type=s3,endpoint_url=https://b172f19b7e057975835d8d311a7b0dbd.r2.cloudflarestorage.com,bucket=github,region=auto,mode=max"
  ]
}
