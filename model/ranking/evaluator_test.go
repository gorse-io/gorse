...
func (m *mockMatrixFactorizationForEval) GetUserFactor(userIndex int32) []float32 {
	panic("implement me")
}

func (m *mockMatrixFactorizationForEval) GetItemFactor(itemIndex int32) []float32 {
	panic("implement me")
}
