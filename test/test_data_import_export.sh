...
gorse import-feedback ${TMP_FEEDBACK_DB} ../example/file_data/feedback_explicit.csv
gorse export-feedback ${TMP_FEEDBACK_DB} ${TMP_FEEDBACK_CSV}

# Import/export items
gorse import-items ${TMP_ITEMS_DB} ../example/file_data/items_id_only.csv
gorse export-items ${TMP_ITEMS_DB} ${TMP_ITEMS_CSV}

# MD5 sum
FEEDBACK_MD5_IMPORT=$(md5sum ../example/file_data/feedback_explicit.csv | awk '{ print $1 }')
FEEDBACK_MD5_EXPORT=$(md5sum ${TMP_FEEDBACK_CSV} | awk '{ print $1 }')
ITEMS_MD5_IMPORT=$(md5sum ../example/file_data/items_id_only.csv | awk '{ print $1 }')
