...
var file_protocol_proto_rawDesc = []byte{
	...
	0x28, 0x0c, 0x52, 0x05, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x22, 0x27, 0x0a, 0x09, 0x50, 0x61, 0x72,
	0x74, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x72, 0x65, 0x66, 0x69, 0x78,
	...
	0x72, 0x72, 0x6f, 0x72, 0x32, 0x91, 0x02, 0x0a, 0x06, 0x57, 0x6f, 0x72, 0x6b, 0x65, 0x72, 0x12,
...
var file_protocol_proto_depIdxs = []int32{
	0, // 0: protocol.Worker.BroadcastModel:input_type -> protocol.Model
	1, // 1: protocol.Worker.BroadcastUserPartition:input_type -> protocol.Partition
	1, // 2: protocol.Worker.BroadcastItemPartition:input_type -> protocol.Partition
	1, // 3: protocol.Worker.BroadcastLabelPartition:input_type -> protocol.Partition
	2, // 4: protocol.Worker.BroadcastModel:output_type -> protocol.Response
	2, // 5: protocol.Worker.BroadcastUserPartition:output_type -> protocol.Response
	2, // 6: protocol.Worker.BroadcastItemPartition:output_type -> protocol.Response
	2, // 7: protocol.Worker.BroadcastLabelPartition:output_type -> protocol.Response
